                    ...
                    <ul class="nav nav-pills flex-sm-column flex-row flex-nowrap flex-shrink-1 flex-sm-grow-0 flex-grow-1 mb-sm-auto mb-0 justify-content-center align-items-center align-items-sm-start"
                        ...
                        <li>
                            <a href="index.php" class="nav-link px-sm-0 px-2">
                                <i class="fa-solid fa-house text-primary"></i><span
                                    class="ms-1 d-none d-sm-inline text-primary">Home</span>
                            </a>
                        </li>
                        <li>
                            <a href="myblog.php" class="nav-link px-sm-0 px-2">
                                <i class="fa-solid fa-signs-post "></i><span class="ms-1 d-none d-sm-inline ">My
                                    blog</span>
                            </a>
                        </li>
                    </ul>
                        ...
                        <div class="card mt-4 mx-2 bg-dark">
                            <div class="card-body">
                                <form method="POST" enctype="multipart/form-data">
                                    ...
                                    } else {  $postEmpty = "Please Insert your Post";} 
                                    }
                                    ?>
